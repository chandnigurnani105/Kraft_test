...
class EventsController extends BaseController
{
    ...
    public function getFutureEventsWithWorkshops()
    {
        ...
        $events = DB::table('events')->join('workshops', 'workshops.event_id', '=', 'events.id')
    ...
    // public function getFutureEventsWithWorkshops()
    // {
    //     $workshop = Workshop::with(array('allChildren' => function ($q) {
    //         $q->with('allChildren')->get();
    //     }))->get()->toArray();
    ...
    public function getWarmupevents(){
        $events = Event::with('workshops')->take(3)->get()->toArray();
        return response()->json($events);
    }
